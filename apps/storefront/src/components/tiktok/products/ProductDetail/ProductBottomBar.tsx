...
export default function ProductBottomBar({ price, onAddToCart, onBuyNow }: ProductBottomBarProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-background border-t border-border p-2 max-w-md mx-auto z-50">
      <div className="flex items-center gap-2">
        ...
        >
          <span className="font-bold text-[15px] leading-tight">Mua ngay</span>
          {price !== undefined && (
