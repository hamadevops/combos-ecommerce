...
import ProductListItem from "@/components/tiktok/products/ProductListItem";
...
export default function ProductsTabContent() {
  ...
  const products =
    data?.pages.flatMap((page) => (page as any).data || (page as any).items || []) || [];
