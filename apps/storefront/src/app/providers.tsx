...
export function Providers({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    // Dynamically configure @vibe/shared client in the browser to avoid static bundling/transpilation errors in dev server
    import("@vibe/shared").then(({ client: sharedClient }) => {
      ...
      console.error("Failed to load and configure @vibe/shared client", err);
    });
  }, []);
