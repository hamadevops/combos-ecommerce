...
const ProductCard = ({ product, compact = false }: ProductCardProps) => {
  ...
  const displaySoldCount = (product as any).soldCount || Math.floor(Math.random() * 900) + 100;
        ...
        <div className="p-2 space-y-2 flex-1 flex flex-col">
          ...
          <div className="mt-auto space-y-2">
            ...
            <div className="flex items-end justify-between gap-1">
              ...
              <button
                className="bg-[#FE2C55] text-white text-[11px] px-3 py-1.5 rounded font-semibold hover:bg-[#FE2C55]/90 transition-colors active:scale-95 mb-0.5"
